...
1. Open a signal to view the records associated with it. <br/><img src={useBaseUrl('img/cse/example-record.png')} alt="Example record" style={{border: '1px solid gray'}} width="800"/>
1. Click **+** on a record. The record's details are displayed. 
